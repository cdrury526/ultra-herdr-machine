...
to Convex and pane I/O belongs to the future visible machine runtime. Harnesses
...
complete enrollment/system installation, actual harness acceptance and task/runtime
operations remain unavailable until their owning phases. Source/config files must remain at most
